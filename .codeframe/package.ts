...
export const build = (cwd: string = process.cwd()): BuildType => {
  ...
  return {
    ...
    windows_x86_64: {
      ...
      -DCMAKE_INSTALL_PREFIX=${OUTPUT_DIR}/webview/windows/x86_64 \
      `,
    ...
    windows_aarch64: {
      ...
      -DBUILD_SHARED_LIBS=ON \
      -DCMAKE_INSTALL_PREFIX=${OUTPUT_DIR}/webview/windows/aarch64 \
      `,
    ...
    linux_x86_64: {
      ...
      -DBUILD_SHARED_LIBS=ON \
      -DCMAKE_INSTALL_PREFIX=${OUTPUT_DIR}/webview/linux/x86_64 \
      `,
    ...
    linux_aarch64: {
      ...
      -DBUILD_SHARED_LIBS=ON \
      -DCMAKE_INSTALL_PREFIX=${OUTPUT_DIR}/webview/linux/aarch64 \
      `,
